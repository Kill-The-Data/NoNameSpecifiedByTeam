...
public class SmartCamZoom : AUnityObserver
{
    ...
    [Tooltip("The base zoom - level aka from 0 to N where N is the lowest threshold")]
    [SerializeField]
    ...
    private float m_CurrentZoomOutLevel = 0;
    private void Awake()
    {
    ...
    private void PositionCamera()
    {
        ...
        cpos.z = LeanTween.easeOutExpo(cpos.z, -m_currentSetting - m_CurrentZoomOutLevel, Time.deltaTime);
